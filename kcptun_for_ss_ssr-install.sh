...
shell_download_link="https://github.com/bingfengbao/kcptun-ss/blob/master/kcptun_for_ss_ssr-install.sh"
program_version_link="https://github.com/bingfengbao/kcptun-ss/blob/master/version.sh"
